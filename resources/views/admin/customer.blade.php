...
<body>
    <main style="max-height: 500px; overflow-y:scroll" ng-controller="customercontroller">
        <div class="container-fluid px-4">
            <h2 class="mt-2">Khách hàng</h2>
            ...
            <table class="table table-hover table-bordered">
                ...
                <tbody>
                    ...
                    <tr ng-repeat="sp in customers|filter: {name:timkiem}">
                                ...
                                <div class="container-fluid">
                                    <div class="row">
                                        <div class="col-6">
                                            ...
                                            <div>
                                                <input type="text" class="form-control" ng-model="customer.name" placeholder="VD: Kim đồng">
                                            </div>
                                        ...
                                        <div class="col-12">
                                            ...
                                            <textarea class="form-control" id="description" name="description"
                                                ng-model="customer.note" rows="5"></textarea>
                                            <!-- <script>
