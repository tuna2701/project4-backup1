...
<body>
    <main style="max-height: 500px; overflow-y:scroll" ng-controller="categorycontroller">
        <div class="container-fluid px-4">
            ...
            <table class="table table-hover table-bordered">
                ...
                <tbody>
                    ...
                    <tr ng-repeat="sp in categories|filter: {name:timkiem}">
                        <td style="width:10px">@{{$index+1}}</td>
                        <td style="width:200px">@{{sp.name}}</td>
                        <td>@{{sp.desc}}</td>
                        <td>@{{sp.created_at | date: 'MM-dd-yyyy h:mm a'}}</td>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <textarea class="form-control" id="description" name="description"
                                                ng-model="category.desc" rows="5"></textarea>
                                            <!-- <script>
